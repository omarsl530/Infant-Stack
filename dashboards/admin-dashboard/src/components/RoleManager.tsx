    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
           ...
           <p className="text-slate-500 mt-1">Define roles and assign permissions.</p>
        </div>
        ...
        {isLoading ? (
            ...
            <tbody>
                ...
                <tr key={role.id}>
                    ...
                    <td className="text-slate-300 text-sm max-w-xs truncate" title={role.description || ''}>
                        {role.description || '-'}
                    </td>
                    <td>
                    ...
                    <td>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-slate-300">{getPermissionCount(role)} access rules</span>
                        </div>
                    </td>
                    <td>
                        {role.is_system ? (
                    ...
                    <td className="text-slate-400 text-sm">{formatDate(role.created_at)}</td>
                    <td>
