    ...
    <div className="space-y-6">
      ...
      <div className="glass-card p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <AlertSummaryTile
            severity="High"
            count={alertSeverity.high}
            color="text-red-400"
            bg="bg-red-400/10"
          />
          <AlertSummaryTile
            severity="Medium"
            count={alertSeverity.medium}
            color="text-amber-400"
            bg="bg-amber-400/10"
          />
          <AlertSummaryTile
            severity="Low"
            count={alertSeverity.low}
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-slate-800/40 border border-slate-700/50 rounded-2xl">
      <div className="flex items-center gap-3">
        <div
          className={`p-2 rounded-lg ${isOnline ? "bg-emerald-500/10 text-emerald-400" : "bg-red-500/10 text-red-400"}`}
        >
...
function AlertSummaryTile({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center p-6 ${bg} rounded-2xl border border-white/5`}
    >
